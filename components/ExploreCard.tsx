...
export function ExploreCard({ id, imgUrl, title, index, active, handleClick }: ExplorerCardProps) {
	return (
		<motion.div
		...
		>
			<img src={`/public${imgUrl}`} alt={title} className="absolute w-full h-full object-cover rounded-[24px] " />
			{active !== id ? (
