		...
		<section className={`${styles.paddings} relative z-10`}>
			...
			>
				...
				>
					...
					because this is really the <span className="font-extrabold text-white">madness of the metaverse</span> of
					today, using only <span className="font-extrabold text-white">VR</span> devices you can easily explore the
				...
				<motion.img
					...
					src={`${moduleExports.assetPrefix || ''}/arrow-down.svg`}
					alt="arrow down"
